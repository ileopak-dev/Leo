export type EvidenceRef = { resourceType: string; id: string; path?: string };
...
export type PatientInsightsDTO = {
  ...
  snapshot: {
    ...
    meds: Array<{ text: string; status?: string; changed?: "started" | "stopped" | "changed"; evidence: EvidenceRef[] }>;
